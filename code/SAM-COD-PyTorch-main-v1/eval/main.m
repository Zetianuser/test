...
%     'PFNet';
        'sam_with_attention_prompt_global_conv'
    };
...
for i = 1:numel(algorithms)
    ...
    for j = 1:numel(datasets)
        dataset      = datasets{j};
        predpath     = ['./results/sam_with_attention_prompt_global_conv/' dataset '/'];
        maskpath     = ['./../../datasets/test/' dataset '/mask/'];
        ...
        names = dir(['./results/sam_with_attention_prompt_global_conv/' dataset '/*.png']);
        names = {names.name}';
