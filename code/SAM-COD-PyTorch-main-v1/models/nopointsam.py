...
from .mmseg.models.sam import ImageEncoderViT, MaskDecoder, TwoWayTransformer, ContrastivePromptGenerator
...
@register('sam_with_no_point')
class NoPointSAM(nn.Module):
