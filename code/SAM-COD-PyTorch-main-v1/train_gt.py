...
def eval_psnr(loader, model, eval_type=None):
    ...
    with torch.no_grad():
        ...
        for batch in loader:
            ...
            pred = torch.sigmoid(model.infer(inp, gt))
        ...
        dist.all_gather(gather_results1, batch_result1)
        dist.all_gather(gather_results2, batch_result2)
        dist.all_gather(gather_results3, batch_result3)
        dist.all_gather(gather_results4, batch_result4)
