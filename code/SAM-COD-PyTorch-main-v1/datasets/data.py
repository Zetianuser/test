...
class test_dataset:
    def __init__(self, image_root, gt_root, testsize):
        ...
        self.init_gt_transform = transforms.ToTensor()
        # self.gt_transform = transforms.Compose([
        #     transforms.Resize((self.trainsize, self.trainsize)),
        #     transforms.ToTensor()])
        self.size = len(self.images)
    ...
    def load_data(self):
        ...
        gt = self.gt_transform(self.binary_loader(self.gts[self.index]))
        init_gt = self.init_gt_transform(self.binary_loader(self.gts[self.index]))
