...
def eval_psnr(loader, model, data_norm=None, eval_type=None, eval_bsize=None,
    ...
    with torch.no_grad():
        ...
        for batch in pbar:
            ...
            result1, result2, result3, result4 = metric_fn(resize_pred, batch['init_gt'])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='save/_cod-sam-vit-h-one-point/config.yaml')
    parser.add_argument('--model', default='./save/_cod-sam-vit-h-one-point/model_epoch_last.pth')
